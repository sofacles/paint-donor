...
const ThirdColorControl: React.FC = () => {
  ...
  const downClick = (event: SyntheticEvent) => {
    event.preventDefault();
    setBlueValue((b) => {
  ...
  return (
    <div style={sliderContainerStyle as React.CSSProperties}>
